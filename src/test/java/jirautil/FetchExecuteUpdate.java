...
public class FetchExecuteUpdate {
	...
	private static String cycleId = "0001503993710547-242ac112-0001";// after ccreating cycle check for example in
																		// inspect element: <li id
																		// ="cycle-0001503993710547-242ac112-0001">
	private static String versionId = "-1";
	private static String projectId = "10000"; // mouse hover of the main main menu any tab like Test andn inspect
												// elemnt & check for example: href:
	...
	public static void main(String[] args) throws JSONException, URISyntaxException, ParseException, IOException {
		...
		/**
		 * Get Execution Id's by CycleId and Add them to Ad Hoc cycle of UnScheduled
		 * Version
		 * 
		 */
	...
	public static void addTestsToCycle(String uriStr, ZFJCloudRestClient client, String accessKey,
		...
		int statusCode = response.getStatusLine().getStatusCode();
		if (statusCode >= 200 && statusCode < 300) {
			LogUtil.infoLog(FetchExecuteUpdate.class, "Tests added Successfully");
		} else {
			try {
